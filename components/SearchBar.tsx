...
export function SearchBar({ onSearch }: { onSearch: (q: string) => void }) {
  ...
  return (
    ...
    >
      ...
      />
      <button type="submit" className="croogle-go" style={{ padding: "12px 20px", borderRadius: "var(--radius)", border: "none", background: "var(--accent)", color: "#fff", cursor: "pointer", fontFamily: "var(--font)", fontWeight: 600 }}>
        Найти
      </button>
    </form>
  );
